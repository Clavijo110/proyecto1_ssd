...
def vista_admin():
    """
    Admin: gestión de pacientes (solo datos identificativos, sin info clínica).
    Puede crear, editar y eliminar pacientes. NO ve observaciones ni gráficas.
    """
    ...
    with tab_lista:
        if not patients:
            ...
            # Tabla administrativa: sin datos clínicos
            df = pd.DataFrame([{
                "ID": p["id"],
